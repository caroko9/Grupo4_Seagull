document.addEventListener('DOMContentLoaded', function () {
    ...
    formulario.addEventListener('submit', function (event) {
      ...
      const descripcionInput = formulario.querySelector('textarea[name="descripcion"]');
      ...
      const imagenInput = formulario.querySelector('input[name="imagen"]');
      ...
      const paisInput = formulario.querySelector('input[name="pais"]');
